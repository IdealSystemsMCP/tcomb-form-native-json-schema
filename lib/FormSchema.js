...
var defaultTemplates = require('tcomb-form-native/lib/templates/bootstrap');
...
class FormSchema extends React.PureComponent<Props, State> {
  ...
  constructor(props: Props) {
    ...
    this.state = {
      ...
      options: { ...getFormOptions(props.schema), stylesheet: props.stylesheet, templates: Object.assign(defaultTemplates,props.templates) }
    };
  }
  ...
  validate = () => {
    var ret = (this._form && this._form.validate && this._form.validate.call)? this._form.validate(): {}
    return ret;
  }
